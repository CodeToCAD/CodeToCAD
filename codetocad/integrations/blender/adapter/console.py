...
def reload_codetocad_modules():
    ...
    import codetocad.integrations.blender

    reload(codetocad.integrations.blender)

    all_providers_modules = inspect.getmembers(
        codetocad.integrations.blender, predicate=inspect.ismodule
    )
    for module_name, module in all_providers_modules:
        print(f"Reloading {module_name}")
        reload(module)

    # from codetocad.integrations.blender.register import register
