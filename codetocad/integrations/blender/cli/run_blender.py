...
from codetocad.integrations.blender.cli.blender_subprocess import run_blender_process
from codetocad.integrations.blender.cli.config import get_blender_executable_path
...
def _run_blender_file(script_file_path: str):
    ...
    """
    from codetocad.integrations.blender.adapter.file_runner import (
...
from codetocad.integrations.blender import *
"""

    def add_running_in_blender_env_var():
        return f"""
from codetocad.integrations.blender.cli.run_blender import set_running_in_blender_environment_var
...
"""
    ...
    def add_debugger_code():
        return """
from codetocad.integrations.blender.blender_actions.console import start_debugger, stop_debugger
