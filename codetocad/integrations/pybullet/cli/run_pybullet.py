...
from codetocad.integrations.pybullet.simulation.simulation import Simulation
...
Examples:
  ...
  python -m codetocad.integrations.pybullet.cli.run_pybullet --gui --duration 5

  # Load and simulate URDF file
  python -m codetocad.integrations.pybullet.cli.run_pybullet robot.urdf --duration 10 --output results/

  # Run with custom parameters
  python -m codetocad.integrations.pybullet.cli.run_pybullet --time-step 0.01 --gravity 0 0 -10

  # Use configuration file
  python -m codetocad.integrations.pybullet.cli.run_pybullet --config simulation.json
        """,
    )
