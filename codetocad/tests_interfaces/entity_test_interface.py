...
class EntityTestInterface(metaclass=ABCMeta):
    ...
    def test_mirror(self):
        ...
        value = instance.mirror("mirror_across_entity_or_landmark","axis","resulting_mirrored_entity_name")
    ...
    def test_circular_pattern(self):
        ...
        value = instance.circular_pattern("instance_count","separation_angle","center_entity_or_landmark","normal_direction_axis")
