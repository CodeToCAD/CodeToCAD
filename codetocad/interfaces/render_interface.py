...
class RenderInterface(metaclass=ABCMeta):
    ...
    def render_image(self, output_file_path:str, overwrite:bool=True, file_type:Optional[str]=None):
        ...
        print("render_image is called in an abstract method. Please override this method.")
        return self
    ...
    def render_video_mp4(self, output_file_path:str, start_frame_number:'int'=1, end_frame_number:'int'=100, step_frames:'int'=1, overwrite:bool=True):
        ...
        print("render_video_mp4 is called in an abstract method. Please override this method.")
        return self
    ...
    def render_video_frames(self, output_folder_path:str, file_name_prefix:str, start_frame_number:'int'=1, end_frame_number:'int'=100, step_frames:'int'=1, overwrite:bool=True, file_type:Optional[str]=None):
        ...
        print("render_video_frames is called in an abstract method. Please override this method.")
        return self
    ...
    def set_frame_rate(self, frame_rate:'int'):
        ...
        print("set_frame_rate is called in an abstract method. Please override this method.")
        return self
    ...
    def set_resolution(self, x:'int', y:'int'):
        ...
        print("set_resolution is called in an abstract method. Please override this method.")
        return self
    ...
    def set_render_quality(self, quality:'int'):
        ...
        print("set_render_quality is called in an abstract method. Please override this method.")
        return self
    ...
    def set_render_engine(self, name:str):
        ...
        print("set_render_engine is called in an abstract method. Please override this method.")
        return self
    ...
    def set_camera(self, camera_name_or_instance:CameraOrItsName):
        ...
        print("set_camera is called in an abstract method. Please override this method.")
        return self
