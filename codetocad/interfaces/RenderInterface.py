...
class RenderInterface(metaclass=ABCMeta):
    ...
    def renderVideoMp4(self, outputFilePath: str, startFrameNumber: 'int' = 1, endFrameNumber: 'int' = 100, stepFrames: 'int' = 1, overwrite: bool = True):
        ...
        print(
            "renderVideoMp4 is called in an abstract method. Please override this method.")
        return self
    ...
    def setRenderQuality(self, quality: 'int'):
        ...
        print(
            "setRenderQuality is called in an abstract method. Please override this method.")
        return self
    ...
    def setRenderEngine(self, name: str):
        ...
        print(
            "setRenderEngine is called in an abstract method. Please override this method.")
        return self
