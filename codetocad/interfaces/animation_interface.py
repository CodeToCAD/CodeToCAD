...
class AnimationInterface(metaclass=ABCMeta):
    ...
    def set_frame_start(self, frame_number:'int'):
        ...
        print("set_frame_start is called in an abstract method. Please override this method.")
        return self
    ...
    def set_frame_end(self, frame_number:'int'):
        ...
        print("set_frame_end is called in an abstract method. Please override this method.")
        return self
    ...
    def set_frame_current(self, frame_number:'int'):
        ...
        print("set_frame_current is called in an abstract method. Please override this method.")
        return self
    ...
    def create_key_frame_location(self, entity:EntityOrItsName, frame_number:'int'):
        ...
        print("create_key_frame_location is called in an abstract method. Please override this method.")
        return self
    ...
    def create_key_frame_rotation(self, entity:EntityOrItsName, frame_number:'int'):
        ...
        print("create_key_frame_rotation is called in an abstract method. Please override this method.")
        return self
