...
class CameraInterface(metaclass=ABCMeta):
    ...
    def createOrthogonal(self):
        ...
        print(
            "createOrthogonal is called in an abstract method. Please override this method.")
        return self
    ...
    def setFocalLength(self, length: float):
        ...
        print(
            "setFocalLength is called in an abstract method. Please override this method.")
        return self
