...
class MaterialInterface(metaclass=ABCMeta):
    ...
    def assign_to_part(self, part_name_or_instance:PartOrItsName):
        ...
        print("assign_to_part is called in an abstract method. Please override this method.")
        return self
    ...
    def set_reflectivity(self, reflectivity:float):
        ...
        print("set_reflectivity is called in an abstract method. Please override this method.")
        return self
    ...
    def set_roughness(self, roughness:float):
        ...
        print("set_roughness is called in an abstract method. Please override this method.")
        return self
