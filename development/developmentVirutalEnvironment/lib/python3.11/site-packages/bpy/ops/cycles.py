...
def use_shading_nodes(override_context: typing.
                      ...
                      execution_context: typing.Union[str, int] = None,
                      undo: typing.Optional[bool] = None):
    ''' Enable nodes on a material, world or light :file: `addons/cycles/operators.py\:22 <https://projects.blender.org/blender/blender-addons/addons/cycles/operators.py$22>`_
