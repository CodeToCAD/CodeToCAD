...
capabilities_parameter_types = {
    ...
    "list[string,list[string],list[float],list[Dimension],Point]": "str|list[str]|list[float]|list[Dimension]|Point]",
    "string,list[string],list[float],list[Dimension],Point,Vertex": "str|list[str]|list[float]|list[Dimension]|Point|Vertex",
    "list[string,list[string],list[float],list[Dimension],Point,Vertex]": "str|list[str]|list[float]|list[Dimension]|Point|Vertex]",
