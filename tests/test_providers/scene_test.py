...
class SceneTest(TestProviderCase, SceneTestInterface):
    ...
    def test_export(self):
        ...
        value = instance.export(file_path="scene-export.png",
    ...
    def test_remove_from_group(self):
        ...
        value = instance.remove_from_group(entity_name="myEntity", group_name="test-scene-group")
    ...
    def test_assign_to_group(self):
        ...
        value = instance.assign_to_group(
            entities=["myEntity"], group_name="test-scene-group",# "remove_from_other_groups"
        )
    ...
    def test_set_background_image(self):
        ...
        value = instance.set_background_image(file_path="bg-image.png", location_x=0, location_y=0)
