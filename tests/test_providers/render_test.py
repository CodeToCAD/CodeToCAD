...
class RenderTest(TestProviderCase, RenderTestInterface):
    ...
    def test_render_video_mp4(self):
        ...
        value = instance.render_video_mp4(
            "output_file_path", "start_frame_number", "end_frame_number", "step_frames", "overwrite")

    @skip("TODO")
    def test_render_video_frames(self):
        instance = Render("")

        value = instance.render_video_frames("output_folder_path", "file_name_prefix",
                                             "start_frame_number", "end_frame_number", "step_frames", "overwrite", "file_type")
