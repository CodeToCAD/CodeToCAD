...
class WireTest(TestProviderCase, WireTestInterface):
    ...
    def test_mirror(self):
        ...
        value = instance.mirror(
            mirror_across_entity="ellipse", axis="z", #"resulting_mirrored_entity_name"
        )
    ...
    def test_linear_pattern(self):
        ...
        value = instance.linear_pattern(instance_count=2, offset=2, )#"direction_axis")
    ...
    def test_loft(self):
        ...
        value = instance.loft("circle", "myLoft")
