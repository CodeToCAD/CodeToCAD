...
ellipse_leg = Sketch("ellipse_leg") \
    .create_ellipse("14mm", "27mm") \
    .extrude("5/2in")
...
ellipse_leg_outer_cutout = Sketch("ellipse_legOuterCutout").create_ellipse("14mm", "27mm") \
    .extrude("1in")
...
Joint(ellipse_leg_top,
      ellipse_leg_outer_cutout_top).translate_landmark_onto_another()
...
Joint(ellipse_leg.get_landmark("ellipse_legOuterCutout_bottom"), ellipse_leg2.get_landmark("bottom")
