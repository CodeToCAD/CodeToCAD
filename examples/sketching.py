...
line1 = triangle_sketch.create_line_to("0,0,0", "1,1,0")
line2 = triangle_sketch.create_line_to(line1.v2, "0,1,0")
line3 = triangle_sketch.create_line_to(line2.v2, line1.v1)
...
line4 = rectangle_lines_sketch.create_line_to(line1.v2, line2.v2)
...
arc_wire = arc_sketch.create_arc([-0.5, 0, 0], 0.25, [1, 1, 0])
