...
Part("filletAllEdgesCylinder").createCylinder(1/2,2).translate(1.5*2,0,0).filletAllEdges("10cm").assignMaterial(blueMaterial)
Part("chamferAllEdgesCylinder").createCylinder(1/2,2).translate(1.5*3,0,0).chamferAllEdges("10cm").assignMaterial(redMaterial)
...
filletTwoEdges.filletEdges("10cm", [filletTwoEdges_edge1, filletTwoEdges_edge2]).translate(0,1.5,0).assignMaterial(blueMaterial)
