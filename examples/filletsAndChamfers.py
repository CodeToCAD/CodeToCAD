...
Part("filletAllEdges").createCube(1, 1, 1).filletAllEdges(
    "10cm").assignMaterial(blueMaterial)
Part("chamferAllEdges").createCube(1, 1, 1).translate(
    1.5, 0, 0).assignMaterial(redMaterial).chamferAllEdges("10cm")

Part("filletAllEdgesCylinder").createCylinder(1/2, 2).translate(1.5 *
                                                                2, 0, 0).filletAllEdges("10cm").assignMaterial(blueMaterial)
Part("chamferAllEdgesCylinder").createCylinder(1/2, 2).translate(1.5 *
                                                                 3, 0, 0).chamferAllEdges("10cm").assignMaterial(redMaterial)
...
filletTwoEdges.filletEdges("10cm", [filletTwoEdges_edge1, filletTwoEdges_edge2]).translate(
    0, 1.5, 0).assignMaterial(blueMaterial)
...
chamferTwoEdges.chamferEdges("10cm", [chamferTwoEdges_edge1, chamferTwoEdges_edge2]).translate(
    1.5, 1.5, 0).assignMaterial(redMaterial)
...
filletTwoFaces.filletFaces("10cm", [filletTwoFaces_face1, filletTwoFaces_face2]).translate(
    1.5*2, 1.5, 0).assignMaterial(blueMaterial)
...
chamferTwoFaces.chamferFaces("10cm", [chamferTwoFaces_face1, chamferTwoFaces_face2]).translate(
    1.5*3, 1.5, 0).assignMaterial(redMaterial)
