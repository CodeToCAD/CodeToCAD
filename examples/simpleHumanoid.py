...
Joint(body,head,body_top,head_bottom).limitLocation(0,-0.3,0,0,0.3,0).limitRotation(0,-20,-30,0,90,30)

# Mark: Attach eye to head:
head_leftEye = head.createLandmark("leftEye", "max-0.1", -0.2, "max/3")
Joint(head, eye, head_leftEye, eye_bottom).limitLocation(0,0,0).limitRotation(0,0,0)
