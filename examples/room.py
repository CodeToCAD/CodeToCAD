...
def create_room():
    ...
    foundation.translate(0, 0, -0.5)  # Lower it slightly
...
if __name__ == "__main__":
    ...
    create_room().export_stl(str(get_temp_stl_export_path()))
