class OnshapeUrl:
    ...
    def __init__(self, document_id: str, workspace_id: str, tab_id: str, base_url: str = "https://cad.onshape.com") -> None:
    ...
    def __repr__(self) -> str:
        return "{}/documents/{}/w/{}/e/{}".format(self.base_url, self.document_id, self.workspace_id, self.tab_id)
