...
class Sketch(SketchInterface):
    ...
    def create_lineBetweenPoints(self, end_at: PointOrListOfFloatOrItsStringValue, start_at: Optional[PointOrListOfFloatOrItsStringValue] = None):
    ...
    def create_arcBetweenThreePoints(self, point_a: 'Point', point_b: 'Point', center_point: 'Point'):
