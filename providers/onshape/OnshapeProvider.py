...
# SA: the activeUrl may become stale or leaky. TODO: implement some sort of activeUrl context container.
activeOnshapeUrl: Optional[OnshapeDefinitions.OnshapeUrl] = None


def setActiveOnshapeUrl(onshapeUrl: OnshapeDefinitions.OnshapeUrl) -> None:
    global activeOnshapeUrl
    activeOnshapeUrl = onshapeUrl
