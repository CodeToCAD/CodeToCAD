...
KEYS = "asdfgh"  # joints 1-6; j / k close/open the gripper
...
# Cap the finger motors: pinching with the full 100 N arm-motor force
# ejects the cube instead of holding it.
GRIP_FORCE = 10.0
CUBE_SIZE = 0.03
